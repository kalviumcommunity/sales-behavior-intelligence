...
render_page_header(
    ...
    f"Welcome back, {CURRENT_USER['name']} — here's your pipeline health and team performance.",
)
...
section_header(
    ...
    "Revenue trend and current pipeline distribution by stage.",
)
...
with col_c1:
    ...
    st.html(
        "<div style='font-size: 14px; font-weight: 600; margin-bottom: 16px;'>Revenue Trend</div>"
    )
    revenue_chart = (
        ...
        .mark_area(
            ...
            color=alt.Gradient(
                gradient="linear",
                stops=[
                    alt.GradientStop(color="#5EE7FF", offset=0),
...
with col_c2:
    st.html("<div class='sbi-card'>")
    st.html(
        "<div style='font-size: 14px; font-weight: 600; margin-bottom: 16px;'>Pipeline by Stage</div>"
    )
    pipeline_chart = (
...
with col_n1:
    ...
    st.html(
        "<div style='font-size: 14px; font-weight: 600; margin-bottom: 16px;'>High Risk Deals</div>"
    )
